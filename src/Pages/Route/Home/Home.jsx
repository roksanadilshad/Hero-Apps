    ...
    bg-clip-text
     text-transparent
      ...
      from-[#632EE3]
       ...
       <p className='lg:text-xl/[32px] px-1 text-[14px]/[20px] text-[#627382] m-2'>At HERO.IO , we craft innovative apps designed to make everyday life simpler, smarter, and more exciting. <br /> Our goal is to turn your ideas into digital experiences that truly make an impact.</p>
...
<div>
  <img src="https://i.ibb.co.com/DfKh1PC5/hero.png" alt="" className='px-3'/>
</div>
<div className=' bg-gradient-to-r 
      from-[#632EE3]
       to-[#9F62F2] lg:py-6 py-1 lg:px-40 w-full text-white mb-8 lg:mb-20'>
  <h2 className='font-bold lg:text-5xl text-3xl lg:w-full w-50%'>Trusted by Millions, Built for You</h2>
  <div className='flex justify-evenly items-center'>
    ...
    <h2 className='lg:font-extrabold font-bold lg:pb-4 pb-1 text-2xl/[20px] lg:text-[64px]/[72px]'>29.6M</h2>
    <p className='lg:text-[14px]/[24px] px-1 text-[12px] text-[#e9e4e4]'>21% more than last month</p>
  </div>
  <div className='text-center py-2 lg:py-10'>
    <p className='lg:text-[14px]/[24px] text-[12px] pb-1 text-[#e9e4e4]'>Total Reviews</p>
    <h2 className='lg:font-extrabold font-bold lg:pb-4 pb-1 text-2xl/[20px] lg:text-[64px]/[72px]'>906K</h2>
    <p className='lg:text-[14px]/[24px] px-1 text-[12px] text-[#e9e4e4]'>46% more than last month</p>
  </div>
  <div className='text-center py-2 lg:py-10'>
    <p className='lg:text-[14px]/[24px] text-[12px] pb-1 text-[#e9e4e4]'>Active Apps</p>
    <h2 className='lg:font-extrabold font-bold lg:pb-4 pb-1 text-2xl/[20px] lg:text-[64px]/[72px]'>132+</h2>
    <p className='lg:text-[14px]/[24px] px-1 text-[12px] text-[#e9e4e4]'>31 more will Launch</p>
  </div>
  </div>
</div>
       ...
       <div>
             ...
             
             {
              apps.length > 8 && (
                ...
                <Link className='btn bg-gradient-to-r 
         from-[#632EE3]
          to-[#9F62F2] text-white m-5 lg:m-20' to='/appsWithTitle' >Show all</Link>
              )
             }
      </div>
       </div>
