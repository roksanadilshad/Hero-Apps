    ...
    return (
        <div>
           <div className='w-11/12 mx-auto text-center pb-40 min-h-120'>
             <h2 className='font-bold text-5xl'> My Installation</h2>
            ...
            <div className='flex justify-between items-center'>
               ...
               <option value='highValue' className='flex justify-around items-center p-1.5 text-[12px] rounded-xl text-[#00D390]'>High-&gt;Low</option>
               <option value='lowValue' className='flex justify-around items-center p-1.5 text-[12px] rounded-xl text-[#00D390]'>Low-&gt;High</option>
