...
const App = ({app}) => {
    ...
    return (
        <div>
            ...
            <Link to={`/appDetails/${id}`} className='flex justify-around items-center p-1.5 text-[12px] rounded-xl text-[#00D390] bg-[#F1F5E8]'> <MdDownload></MdDownload> {downloads}M</Link>
